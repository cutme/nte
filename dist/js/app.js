...
__webpack_require__("./src/js/scrollpos.js"); //require('./js/scrollprogress.js');


__webpack_require__("./src/js/carousels.js");

__webpack_require__("./src/js/thumbs.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const homeCarousel = function () {
    const glide = new glide_esm(home, {
      type: 'carousel',
  ...
  const thumbsCarousel = function () {
    const glide = new glide_esm(thumbs, {
      type: 'carousel',
      animationDuration: 600,
      autoplay: false,
      gap: 10,
...
(function () {
  const WebFont = __webpack_require__("./node_modules/webfontloader/webfontloader.js");
...
document.addEventListener('DOMContentLoaded', function () {
  if (document.getElementsByClassName('js-image').length > 0) {
    let image = _node_modules_glightbox_dist_js_glightbox_js__WEBPACK_IMPORTED_MODULE_0___default()({
      selector: 'js-image'
    });
  }
}, false);
...
/* harmony import */ var custom_select__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("./node_modules/custom-select/build/index.js");
/* harmony import */ var custom_select__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(custom_select__WEBPACK_IMPORTED_MODULE_2__);

const scrollPlugin = gsap_all__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"];
...
(function (window, document, cutme, undefined) {
  ...
  (function () {
    ...
    const init = function () {
      const cstSel = custom_select__WEBPACK_IMPORTED_MODULE_2___default()(select);
...
const {
  detect
} = __webpack_require__("./node_modules/detect-browser/index.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.animsInit = function () {
    for (let i = 0; i < anims.length; i++) {
      ...
      const inview = inview__WEBPACK_IMPORTED_MODULE_0___default()(anims[i], function (isInView) {
        if (isInView) {
          anims[i].classList.add('anim--visible');
          this.destroy();
        }
...
const bodyScrollLock = __webpack_require__("./node_modules/body-scroll-lock/lib/bodyScrollLock.min.js");
...
document.addEventListener('DOMContentLoaded', function () {
  (function () {
    ...
    const action = function () {
      ...
      ww = window.innerWidth; // Narrow top
